...
→ See `golang-code-quality` skill for naming conventions that reduce the need for comments.
...
Add a `Play:` line linking to a runnable Go Playground example when it materially helps readers:
