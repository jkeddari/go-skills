...
→ See `golang-project` skill for automating changelog generation and release workflows.

## README.md

A LICENSE file MUST exist in every project. A README is the front page of your project. Make it simple, clear, and scannable. A copy-paste starting point is available in the [README template](../assets/docs/README.md).
...
Start from the [CONTRIBUTING template](../assets/docs/CONTRIBUTING.md) and remove sections that do not apply.
...
CHANGELOG MUST be updated for every release. Track notable changes for each release. Use [Keep a Changelog](https://keepachangelog.com/) format. Start from the [CHANGELOG template](../assets/docs/CHANGELOG.md).
