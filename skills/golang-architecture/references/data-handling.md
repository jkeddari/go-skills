...
When transferring large data between services (for example, a large database export or HTTP response), use standard iterators or explicit streaming to keep memory bounded:
