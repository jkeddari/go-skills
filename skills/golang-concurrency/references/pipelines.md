...
Test the shutdown contract directly: cancel the parent context, close owned inputs, and require workers to report completion within a bounded test deadline.
