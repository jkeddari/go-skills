...
→ See `golang-performance` and its `benchmark-compiler-analysis.md` reference for escape analysis, assembly, SSA, and inlining diagnostics. Its `benchmark-trace.md` reference covers execution-trace analysis.
