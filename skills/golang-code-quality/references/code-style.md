...
This covers **function parameters**, not method receivers (see `golang-code-quality` skill for receiver rules).
...
-> See the `golang-code-quality` skill for pointer vs value **receiver** rules.
